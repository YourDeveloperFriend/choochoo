    ...
    <div>
      ...
      <ul>
        <li>
          ...
          track. This is called the &quot;master network.&quot; Players get 4
          builds per turn instead of the normal 3.
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            next cube from this track will be returned to the bag and the color
            of The Loop will be changed to this color. The two hexes of The Loop
            should be treated as a single hex; goods not matching the color of
            The Loop may pass through it, optionally exiting from a different
            hex than the one they entered.
          </p>
          <p>
            Deliveries to The Loop give the current player a bonus $3. This is
            given to the current player regardless of what track was used for
            the delivery.
          </p>
        </li>
        <li>
          <p>
            ...
            advanced their player stone <i>up</i> to the higher layers of the
            Locomotive track can use some of it for <i>income</i>. Up to 1 of
            the Government Links may be run for Income at layers 2 and 3 of the
            chart, and up to 2 at layers 4 and 5. This is a power that may be
            used as part of your normal delivery allowance, it is not additive
            to your normal Locomotive range, which is the number inside the box.
          </p>
        </li>
        <li>
          <p>
            Players may move their player stone to the <i>right</i> on the
            Locomotive track by skipping one of their two goods movements as
            usual. If there is nowhere to move to the right, their stone is
            stuck at that level until they move up by winning the Locomotive
            role during the auction.
          </p>
        </li>
        <li>
          <p>
            The row of a player&apos;s locomotive track does not impact
            expenses; only the range of their locomotive.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          track contributes to income; this happens at every other layer.
        </li>
        <li>
          <b>Roads:</b> cost $4. The brown park/cemetery spaces are impassable
        ...
        <li>
          <p>
            ...
            government track is chosen by a 2d6 die roll during setup. Check the
            game log for which city was chosen.
          </p>
          <p>
            2: Midway, 3: Dempster-Skokie, 4: Linden, 5: Damen, 6: Addison, 7:
            The Loop, 8: Belmont, 9: Cottage Grove, 10: Cermak, 11: Forest Park,
            12: O&apos;Hare
          </p>
        </li>
      </ul>
