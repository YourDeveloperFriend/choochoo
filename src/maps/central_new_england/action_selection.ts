...
export const ActionMoney = new MapKey(
  "CentralNewEnglandActionMoney",
  ActionZod.parse,
  z.number().parse,
);

export class CentralNewEnglandSelectActionPhase extends SelectActionPhase {
...
export class CentralNewEnglandSelectAction extends SelectAction {
  private readonly actionMoney = injectState(ActionMoney);
