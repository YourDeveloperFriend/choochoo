...
export function ChesapeakeAndOhioTextures(props: TexturesProps) {
  return (
    <>
      <ChesapeakeAndOhioFactories {...props} />
      <ChesapeakeAndOhioRivers />
    </>
  );
}

function ChesapeakeAndOhioFactories(props: TexturesProps) {
...
function ChesapeakeAndOhioRivers() {
  return (
    <>
      <path
